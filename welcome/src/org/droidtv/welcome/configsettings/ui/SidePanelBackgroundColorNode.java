...
public class SidePanelBackgroundColorNode extends MultiSliderNode {
    ...
    private void initialize() {
        mCurrentColor = WelcomeDataManager.getInstance().getSidePanelBackgroundColor();
    }
    ...
    public void setColorValue(Context context, int index, int value) {
        ...
        mCurrentColor = color;
     //   WelcomeDataManager.getInstance().changeSidePanelBackgroundColor(color);
    }
    ...
    //	WelcomeDataManager.getInstance().saveSidePanelBackgroundColor(mCurrentColor);
    }
}
