...
public class SidePanelNonHighlightedTextColorNode extends MultiSliderNode {
    ...
    private void initialize() {
        mCurrentColor = WelcomeDataManager.getInstance().getSidePanelNonHighlightedTextColor();
    }
    ...
    public void setColorValue(Context context, int index, int value) {
        ...
        mCurrentColor = color;
        WelcomeDataManager.getInstance().changeSidePanelNonHighlightedTextColor(color);
    }
    ...
    public void onDismissed() {
    	WelcomeDataManager.getInstance().saveSidePanelNonHighlightedTextColor(mCurrentColor);
    }
